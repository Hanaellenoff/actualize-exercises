...
# on line 14: in a hash you need to use the key word here you use "dogs" 
# and instead of using the key as what its equaled to you use the value since it equals 2